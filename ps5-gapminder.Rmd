...
```{r}
americas_co2 <- gm %>% 
  filter(!is.na(co2_PC), !is.na(region), !is.na(name), !is.na(time), time == 2016, region == "Americas") %>% 
  group_by(region, name) %>% 
  summarize(co2mean = sum(co2_PC)) %>% 
  arrange(co2mean)
head(americas_co2, 3)
tail(americas_co2, 3)

asia_co2 <- gm %>% 
  filter(!is.na(co2_PC), !is.na(region), !is.na(name), !is.na(time), time == 2016, region == "Asia") %>% 
  group_by(region, name) %>% 
  summarize(co2mean = sum(co2_PC)) %>% 
  arrange(co2mean)
head(asia_co2, 3)
...
europe_co2 <- gm %>% 
  filter(!is.na(co2_PC), !is.na(region), !is.na(name), !is.na(time), time == 2016, region == "Europe") %>% 
  group_by(region, name) %>% 
  summarize(co2mean = sum(co2_PC)) %>% 
  arrange(co2mean)
head(europe_co2, 3)
...
oceania_co2 <- gm %>% 
  filter(!is.na(co2_PC), !is.na(region), !is.na(name), !is.na(time), time == 2016, region == "Oceania") %>% 
  group_by(region, name) %>% 
  summarize(co2mean = sum(co2_PC)) %>% 
  arrange(co2mean)
head(europe_co2, 3)
...
africa_co2 <- gm %>% 
  filter(!is.na(co2_PC), !is.na(region), !is.na(name), !is.na(time), time == 2016, region == "Africa") %>% 
  group_by(region, name) %>% 
  summarize(co2mean = sum(co2_PC)) %>% 
  arrange(co2mean)
head(africa_co2, 3)
